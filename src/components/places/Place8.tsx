          ...
          <div className="w-full flex h-[400px] justify-center items-center flex-row-reverse max-mobile_lg:h-full gap-4 max-mobile:gap-2">
            ...
            >
              <Image
                src={bwindi3}
                alt="Image 1"
                className="object-contain h-[380px] w-max rounded-[10px] max-mobile:max-h-[210px] max-x_mobile:max-h-[170px] max-mobile_lg:max-h-[360px] max-tablet:max-h-[260px] max-tablet_lg:max-h-[340px]"
              />
            </motion.div>
